 ...
 *
 * $Id: TWUProperties.java,v 1.1 2010/09/03 09:58:17 manduchi Exp $
 *
 * ------------------------------------------------------------------------ 
...
public class TWUProperties
{
    ...
    TWUProperties(String SigURL, String user_agent)
    {
        final String
            ...
            : "TWUProperties.java for jScope ($Revision: 1.1 $)";
    ...
    revision()
    {
        return "$Id: TWUProperties.java,v 1.1 2010/09/03 09:58:17 manduchi Exp $";
    }
...
/* ------------------------------------------------------------------------ */
// End of $Id: TWUProperties.java,v 1.1 2010/09/03 09:58:17 manduchi Exp $
/* ------------------------------------------------------------------------ */
