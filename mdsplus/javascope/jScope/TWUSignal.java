...
public class TWUSignal
{
    ...
    prepareToRead(int firstSample, int step, int maxSamples)
    {
        try
        {
            ...
            con.setRequestProperty("User-Agent",
                                   "TWUSignal.java for jScope ($Revision: 1.1 $)");
    ...
    revision()
    {
        return "$Id: TWUSignal.java,v 1.1 2010/09/03 09:58:17 manduchi Exp $";
    }
}

/* ------------------------------------------------------------------------ */
// $Id: TWUSignal.java,v 1.1 2010/09/03 09:58:17 manduchi Exp $
/* ------------------------------------------------------------------------ */
