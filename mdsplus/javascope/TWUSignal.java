 ...
 *
 * $Id: TWUSignal.java,v 1.18 2002/11/29 13:45:20 jgk Exp $
 *
...
public class TWUSignal
{
    ...
    prepareToRead(int firstSample, int step, int maxSamples)
    {
        try
        {
            ...
            con.setRequestProperty("User-Agent",
                                   "TWUSignal.java for jScope ($Revision: 1.18 $)");
    ...
    revision()
    {
        return "$Id: TWUSignal.java,v 1.18 2002/11/29 13:45:20 jgk Exp $";
    }
}
