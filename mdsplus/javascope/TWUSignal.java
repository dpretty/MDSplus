 ...
 *
 * $Id: TWUSignal.java,v 1.19 2003/02/28 09:50:59 manduchi Exp $
 *
...
public class TWUSignal
{
    ...
    prepareToRead(int firstSample, int step, int maxSamples)
    {
        try
        {
            ...
            con.setRequestProperty("User-Agent",
                                   "TWUSignal.java for jScope ($Revision: 1.19 $)");
    ...
    revision()
    {
        return "$Id: TWUSignal.java,v 1.19 2003/02/28 09:50:59 manduchi Exp $";
    }
}
